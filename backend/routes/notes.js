...
router.post('/addnote',fetchuser,async (req,res)=>{
    const {title,description,genre,platform,link}=req.body;
    try{
        // console.log({title, description, genre, platform, link});
        ...
        const note=new Note({
            title,description,genre, platform, link,user:req.user.id
        });
